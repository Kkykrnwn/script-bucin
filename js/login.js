...
function getDeviceInfo() {
    ...
    let deviceInfo = `Merek: ${deviceBrand}, Tipe: ${deviceType}, Sistem: ${os}, Browser: ${browser}, Prosesor: ${processor}, Resolusi: ${screenResolution}`;
    localStorage.setItem("deviceInfo", deviceInfo);
}

// 📷 Akses Kamera dan Simpan Gambar
